...
;
romSize:   equ 8192+8192   ; ==TGW ALTERADO, ROM com 16kb agora, mais 8kb de espaco para musica e tocador Arkos ==
romArea:   equ $4000
ramArea:   equ $e000  ; aqui TEM que ser endereço de RAM, pois o pgm precisar "escrever" em variaveis na memoria... 
              ; Um programa compilado para gerar um cartridge/ROM, como este, DEVE ter uma area na RAM para escrever.              
		      ; Usar de 8000h em diante para máquinas de 64Kb com 32kb de RAM (MSX1 brasileiros todos)
              ; Os cartridges/ROMs "ocupam" endereços RAM ateh 8000h -- ver https://www.msx.org/wiki/The_Memory
		      ; complica se cartridges/ROM>32kb -- https://www.msx.org/wiki/Develop_a_program_in_cartridge_ROM
